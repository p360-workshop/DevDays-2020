...
Check out https://github.com/siavash1986/gs-accessing-data-jpa[gs-accessing-data-jap] repository to your local development environment and open `initial` folder

The following listing shows the `build.gradle` file is located in the `initial` folder:
